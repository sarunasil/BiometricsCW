...
def get_measurements(initial_img, contour_img, contour, body_parts):
    ...
    #TODO Get measurement height (y coordinate) as well as width
...
def export_features(human_data, export_filename='features_training.yaml'):
...
def prepare():
    ...
    for img_name in img_names:
        ...
        #display_img(pose_img, wait=True)
    #display_sidebyside(img, title='img', wait=True)
