...
#input_img = "Pose_Estimation/DSC00180.JPG"
input_img = "running.jpg"
input_img = "Pose_Estimation/sample.jpg"
proto = "Pose_Estimation/pose/body_25/body_25_deploy.prototxt"
model = "Pose_Estimation/pose/body_25/pose_iter_584000.caffemodel"
dataset = "BODY"

# proto = "Pose_Estimation/pose/coco/deploy_coco.prototxt"
# model = "Pose_Estimation/pose/coco/pose_iter_440000.caffemodel"
# dataset = "COCO"
...
for pair in POSE_PAIRS:
    ...
    if points[idFrom] and points[idTo]:
        cv.line(frame, points[idFrom], points[idTo], (255, 74, 0), 1)
        cv.ellipse(frame, points[idFrom], (2, 2), 0, 0, 360, (255, 255, 255), cv.FILLED)
        cv.ellipse(frame, points[idTo], (2, 2), 0, 0, 360, (255, 255, 255), cv.FILLED)
        cv.putText(frame, str(idFrom), points[idFrom], cv.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255),1,cv.LINE_AA)
        #cv.putText(frame, str(idTo), points[idTo], cv.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255),1,cv.LINE_AA)

t, _ = net.getPerfProfile()
freq = cv.getTickFrequency() / 1000
cv.putText(frame, '%.2fms' % (t / freq), (10, 20), cv.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255),2,cv.LINE_AA)

#cv.resizeWindow(kwinName, (1200, 1000))
cv.imshow(kwinName, frame)
cv.waitKey(0)
#cv.imwrite('result_'+input_img,frame)
